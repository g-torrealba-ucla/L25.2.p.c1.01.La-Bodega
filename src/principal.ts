...
let articulo1: Cl_articulo = new Cl_articulo(10); // Especificar el tipo Cl_articulo
let articulo2: Cl_articulo = new Cl_articulo(20);
let articulo3: Cl_articulo = new Cl_articulo(14);
let articulo4: Cl_articulo = new Cl_articulo(6);
let articulo5: Cl_articulo = new Cl_articulo(4);

let bodega: Cl_bodega = new Cl_bodega(); // Especificar el tipo Cl_bodega
